            ...
            {listLavori.map((item, index) => (
                <Accordion key={item.idOrdineWeb }>
                    <AccordionSummary
                        ...
                        id="panel1a-header"
                        sx={{ bgcolor: '#f1f1f1', border: 1, borderColor: '#aaa', borderRadius: 1, display: 'flex', alignItems: 'center', padding:0, height: '15px', width:'710px' }}
                        className='acodion-lavori' 
                    >
                    ...
                    <AccordionDetails
                          sx={{ bgcolor: "", display: '', fontSize: 11, width: '710px', border:'1px solid #ddd', }}
                    >
                        <div className="">
                                ...
                                <div className="w-[150px]">
                                    {item.idOrdineWeb ?
                                        <>
                                            ...
                                            >
                                                <span className={`bg-[${item.coloreStatoHTMLO}] ${item.omaggio == 1 ?'text-[white]':''} min-w-[118px] text-center text-[11px]`}>
                                                    {item.statoStrO}
                                                </span>
                                            </p>
