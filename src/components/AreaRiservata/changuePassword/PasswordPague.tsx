        ...
        <div className="ms-4 p-5 flex items-center justify-start w-full flex-col">
          <form className="bg-white w-auto  h-auto flex flex-col items-start gap-[2rem]">
            ...
            <div className="font-semibold lg:flex  items-center w-full">
              ...
              <input type="text"  className="bg-[#e8e8e8] w-72 lg:w-full mt-4 lg:mt-0 mr-4 p-3 focus:outline-none"/>
            </div>
            <div className="font-semibold lg:flex w-full items-center">
              <label  className="w-full block">Riscrivi la nouva password</label>
              <input type="password"  className="bg-[#e8e8e8]  w-72 mr-4 lg:w-full mt-4 lg:mt-0 p-3 focus:outline-none" />
            </div>
