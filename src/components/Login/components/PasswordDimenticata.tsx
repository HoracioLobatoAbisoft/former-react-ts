      ...
      <div>
        ...
        <div className="py-20 px-10">
          ...
          <div className="flex justify-center mb-4">
            <button
              type="submit"
              className="flex mt-4 items-center justify-center px-8 focus:outline-none text-white text-sm sm:text-base bg-[#f58220] rounded-md py-2 transition duration-150 ease-in"
            >
              RIGENERA
            </button>
          </div>
