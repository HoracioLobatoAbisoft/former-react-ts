    ...
    <div className="border-[#e2e2e2] border-b flex w-full flex-col pt-3 ">
      <div className="w-full flex justify-between gap-5 items-center mb-3">
        ...
        <div className="flex w-[72%] justify-between">
          <select name={name} onChange={handleChange} className="rounded-3xl block w-[85%] text-gray-700 border outline-none border-gray-200
          py-1 px-3 leading-tight text-xs">
            {
              options.map((elem,i) => (
