      ...
      <div className="flex gap-5 mt-4">
        ...
        >
          <div className="gap-10 bg-gray-200 mt-8 flex justify-center items-center text-[#f58220] py-8">
            <h2>
              <span className="border-[.2rem] border-[#f58220] p-3 rounded font-bold ">
                A
              </span>
              <span className="border-[.2rem] border-[#f58220] p-3 rounded font-bold">
                Z
            ...
            <h2 className="font-extrabold gre tracking-wider uppercase text-3xl">
              Glossario Tipografico
            </h2>
          </div>
          <div className="w-full flex justify-center ">
            <p className="whitespace-normal text-justify w-3/6 ml-1">
              <b>Benvenuti nel Glossario Tipografico!</b>
              <br />
              In questa sezione troverete un aiuto per comprendere le
              terminologie più utilizzate nel mondo della Tipografia. Vi basterà
              cercare una parola o parte di essa e otterrete tutti i termini
              corrispondenti con la relativa definizione.
            </p>
          </div>
          <div className="flex w-full justify-center gap-3 items-center">
            ...
            <input
              type="text"
              className="bg-gray-200 w-[30rem]  p-3 focus:outline-none rounded"
