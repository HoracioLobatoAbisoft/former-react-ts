...
const RowFileEnviato = ({ dataLavoro, selectedFronte, setSelectedFronte, selectedRetro, setSelectedRetro, handlePutUploadFileLavoro, setUploadOk, uploadOk, setUploadOkStr, uploadOkStr, clearSelectFile }: RowFileEnviatoProps) => {
    ...
    return (
        <div className="font-['Arial']">
            <h4 className="w-full bg-[#f58220] text-white uppercase   mt-[5px] mb-[10px] pt-[2px] pl-[20px] text-[12px] font-bold flex justify-between">
                ...
                <a href={GLOBAL_CONFIG.IMG_IP + "/suggerimenti-per-inviarci-i-file"} target="_blank" className="flex items-end text-[10px] font-[400]\ p-[3px] hover:underline text-white rounded-[5px]">
            ...
            <div className="mt-[10px] border-[1px] border-[#aaa] rounded-[5px] ">
                ...
                <div className="w-full flex gap-3 pb-[10px]">
                    ...
                    <div className="w-full">
                        <div className="text-[11px] flex  items-end">
                            <div className="flex items-center gap-2">
                                ...
                                <SectionEnviaFile selectedFile={selectedFronte} setSelectedFIle={setSelectedFronte} idInput="fronte" uploadOk={uploadOk} setUploadOk={setUploadOk} uploadOkStr={uploadOkStr} setUploadOkStr={setUploadOkStr} clearSelectFile={clearSelectFile} />
                            </div>
                        </div>
                        <div className="text-[11px] flex  ms-1">
