...
const SectionEnviaFile = ({ selectedFile, setSelectedFIle, idInput, setUploadOk, uploadOk, setUploadOkStr, uploadOkStr }: PropsEnviaFile) => {
                ...
                {selectedFile != null ?
                    <div className="w-[399px] mt-[2px] flex justify-between  border-[1px] border-[#ededed] " >
                        <div className="p-[10px] border-r border-r-[#ededed]">
                            <img src={GLOBAL_CONFIG.IMG_IP + "/CuteWebUI_Uploader_Resource.axd?type=file&file=circle.png&_ver=638299872000000000"} width="16" height="16" className=""></img>
                        </div>
                        <p className="p-[10px]">
                            {selectedFile.name}
                        </p>
                        {uploadOkStr === 'ok' ?
                            <button className="p-[10px] border-l border-l-[#ededed] " onClick={() => { }}>
                                <img src={GLOBAL_CONFIG.IMG_IP + "/CuteWebUI_Uploader_Resource.axd?type=file&file=uploadok.png&_ver=638303634931082757"} width="16" height="16"></img>
                            </button>
                            :
                            <button className="p-[10px] border-l border-l-[#ededed] " onClick={() => setSelectedFIle(null)}>
                                <img src={GLOBAL_CONFIG.IMG_IP + "/CuteWebUI_Uploader_Resource.axd?type=file&file=stop.png&_ver=638299872000000000"} width="16" height="16"></img>
                            </button>
