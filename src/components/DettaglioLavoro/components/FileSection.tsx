        ...
        <div className="text-[11px]">
            ...
            <div className="mt-[10px] border-[1px] border-[#aaa] rounded-[5px] pl-[5em]">
                <div className="flex items-center ">
                    ...
                    <a href="" className="flex  hover:underline" ><span dangerouslySetInnerHTML={{ __html: String(dataLavoro?.hrefFronteInnerText) }}></span> </a>
                </div>
                {(dataLavoro?.fronteRetro && dataLavoro.sorgenteRetro > 0) ?
                    <div className="flex items-center ml-[4px]">
                        <p className="p-[10px]"><b>Retro: </b></p>
                        <img src={GLOBAL_CONFIG.IMG_IP + "/img/icoFileTypePDF.png"} className="h-[16px] mr-[2em]"></img>
                        <a href="" className="flex gap-[2em] hover:underline"><span dangerouslySetInnerHTML={{ __html: String(dataLavoro?.hrefRetroInnerText) }}></span></a>
                    </div>
                    : null
                }
            </div>
